...
const translations = {
  en: {
    ...
    'vp1.tagline': 'Luxury in every detail',
    'vp1.desc': 'Premium beauty salon website with online booking, service gallery and a loyalty system built to convert visitors into regulars.',
    'vp1.f1': 'Online appointment booking', 'vp1.f2': 'Work gallery & portfolio', 'vp1.f3': 'Loyalty program', 'vp1.f4': 'Fully responsive design',
    'vp2.cat': 'Web Development', 'vp2.title': 'Café "Moka"', 'vp2.short': 'Cozy digital home with menu, atmosphere & online reservations',
    'vp2.tagline': 'The taste that stays with you',
    'vp2.desc': 'Full-featured café website with interactive menu, table reservation system and online delivery — all wrapped in a warm, inviting design.',
    'vp2.f1': 'Interactive digital menu', 'vp2.f2': 'Table reservation system', 'vp2.f3': 'Online delivery integration', 'vp2.f4': 'Cozy atmospheric design',
    'vp3.cat': 'Web + Mobile', 'vp3.title': 'Quest Room "Phantom Zone"', 'vp3.short': 'Immersive escape room with team booking & leaderboards',
    'vp3.tagline': 'Adventure awaits',
    'vp3.desc': 'Immersive escape room website with scenario descriptions, online booking for teams, live countdown timer and leaderboards to fuel the competition.',
    'vp3.f1': 'Scenario descriptions & previews', 'vp3.f2': 'Group & team booking', 'vp3.f3': 'Live countdown timer', 'vp3.f4': 'Leaderboards',
    ...
    'vp4.tagline': 'Comfort and flavour',
    'vp4.desc': 'Premium restaurant landing with an emphasis on atmosphere, seasonal menu highlights and special offers — crafted to drive reservations.',
    'vp4.f1': 'Seasonal & special menus', 'vp4.f2': 'Table reservation system', 'vp4.f3': 'Atmosphere photo gallery', 'vp4.f4': 'Special offers & events',
    'vp5.cat': 'Web Development', 'vp5.title': 'PrintCraft Typography', 'vp5.short': 'Full digital storefront with instant quote calculator',
    'vp5.tagline': 'Print that impresses',
    'vp5.desc': 'Corporate website for a printing company featuring a full service catalogue, instant price calculator and a portfolio of completed works.',
    'vp5.f1': 'Full service catalogue', 'vp5.f2': 'Instant price calculator', 'vp5.f3': 'Portfolio of works', 'vp5.f4': 'Online order & quote form',
    'vp.watch': 'Watch Presentation',
  ...
  ru: {
    ...
    'vp1.tagline': 'Роскошь в каждой детали',
    'vp1.desc': 'Сайт премиального салона красоты с онлайн-записью, галереей работ и системой лояльности для превращения посетителей в постоянных клиентов.',
    'vp1.f1': 'Онлайн-запись', 'vp1.f2': 'Галерея работ', 'vp1.f3': 'Программа лояльности', 'vp1.f4': 'Адаптивный дизайн',
    'vp2.cat': 'Веб-разработка', 'vp2.title': 'Кафе «Moka»', 'vp2.short': 'Уютный цифровой дом с меню, атмосферой и онлайн-бронированием',
    'vp2.tagline': 'Вкус, который остаётся',
    'vp2.desc': 'Полноценный сайт для кафе с интерактивным меню, системой бронирования столиков и онлайн-доставкой — всё в тёплом уютном дизайне.',
    'vp2.f1': 'Интерактивное меню', 'vp2.f2': 'Бронирование столиков', 'vp2.f3': 'Онлайн-доставка', 'vp2.f4': 'Атмосферный дизайн',
    ...
    'vp3.tagline': 'Приключение ждёт',
    'vp3.desc': 'Сайт для квест-комнаты с описанием сценариев, онлайн-бронированием для команд, таймером обратного отсчёта и таблицей лидеров.',
    'vp3.f1': 'Описания сценариев', 'vp3.f2': 'Групповое бронирование', 'vp3.f3': 'Таймер обратного отсчёта', 'vp3.f4': 'Таблица лидеров',
    ...
    'vp4.tagline': 'Уют и вкус',
    'vp4.desc': 'Лендинг премиального ресторана с акцентом на атмосферу, сезонное меню и специальные предложения — создан для увеличения бронирований.',
    'vp4.f1': 'Сезонное меню', 'vp4.f2': 'Бронирование столиков', 'vp4.f3': 'Фотогалерея', 'vp4.f4': 'Спецпредложения и события',
    'vp5.cat': 'Веб-разработка', 'vp5.title': 'Типография PrintCraft', 'vp5.short': 'Полноценный сайт с мгновенным калькулятором стоимости',
    'vp5.tagline': 'Печать, которая впечатляет',
    'vp5.desc': 'Корпоративный сайт для типографии с каталогом услуг, мгновенным калькулятором стоимости и портфолио выполненных работ.',
    'vp5.f1': 'Каталог услуг', 'vp5.f2': 'Калькулятор стоимости', 'vp5.f3': 'Портфолио работ', 'vp5.f4': 'Форма заказа и расчёта',
    'vp.watch': 'Смотреть презентацию',
  ...
  uk: {
    ...
    'vp1.tagline': 'Розкіш у кожній деталі',
    'vp1.desc': 'Сайт преміального салону краси з онлайн-записом, галереєю робіт та системою лояльності для перетворення відвідувачів на постійних клієнтів.',
    'vp1.f1': 'Онлайн-запис', 'vp1.f2': 'Галерея робіт', 'vp1.f3': 'Програма лояльності', 'vp1.f4': 'Адаптивний дизайн',
    'vp2.cat': 'Веб-розробка', 'vp2.title': 'Кафе «Moka»', 'vp2.short': 'Затишний цифровий дім з меню, атмосферою та онлайн-бронюванням',
    'vp2.tagline': 'Смак, що залишається',
    'vp2.desc': 'Повноцінний сайт для кафе з інтерактивним меню, системою бронювання столиків та онлайн-доставкою — все у теплому затишному дизайні.',
    'vp2.f1': 'Інтерактивне меню', 'vp2.f2': 'Бронювання столиків', 'vp2.f3': 'Онлайн-доставка', 'vp2.f4': 'Атмосферний дизайн',
    ...
    'vp3.tagline': 'Пригода чекає',
    'vp3.desc': 'Сайт для квест-кімнати з описом сценаріїв, онлайн-бронюванням для команд, таймером зворотного відліку та таблицею лідерів.',
    'vp3.f1': 'Описи сценаріїв', 'vp3.f2': 'Групове бронювання', 'vp3.f3': 'Таймер зворотного відліку', 'vp3.f4': 'Таблиця лідерів',
    ...
    'vp4.tagline': 'Затишок і смак',
    'vp4.desc': 'Лендінг преміального ресторану з акцентом на атмосферу, сезонне меню та спеціальні пропозиції — створений для збільшення бронювань.',
    'vp4.f1': 'Сезонне меню', 'vp4.f2': 'Бронювання столиків', 'vp4.f3': 'Фотогалерея', 'vp4.f4': 'Спецпропозиції та події',
    'vp5.cat': 'Веб-розробка', 'vp5.title': 'Типографія PrintCraft', 'vp5.short': 'Повноцінний сайт з миттєвим калькулятором вартості',
    'vp5.tagline': 'Друк, що вражає',
    'vp5.desc': 'Корпоративний сайт для типографії з каталогом послуг, миттєвим калькулятором вартості та портфоліо виконаних робіт.',
    'vp5.f1': 'Каталог послуг', 'vp5.f2': 'Калькулятор вартості', 'vp5.f3': 'Портфоліо робіт', 'vp5.f4': 'Форма замовлення та розрахунку',
    'vp.watch': 'Дивитися презентацію',
